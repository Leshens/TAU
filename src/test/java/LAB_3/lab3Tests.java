...
public class lab3Tests {
  ...
  public void cartTest() {
    loadPage(driverChrome, "https://www.saucedemo.com/");
    logIn(driverChrome,"standard_user","secret_sauce");
    addToCart(driverChrome,"*[data-test=\"add-to-cart-sauce-labs-backpack\"]");
    driverChrome.findElement(By.linkText("1")).click();
    assertThat(driverChrome.findElement(By.cssSelector(".inventory_item_name")).getText(), is("Sauce Labs Backpack"));
    driverChrome.close();
  }
